...
const config: ForgeConfig = {
    packagerConfig: {
        ...
        executableName: APP_CONFIG.protocolName,
        win32metadata: {
            CompanyName: APP_CONFIG.author,
            OriginalFilename: `${APP_CONFIG.protocolName}.exe`,
            ProductName: APP_CONFIG.name,
            InternalName: APP_CONFIG.protocolName,
        },
    },
    hooks: {
    ...
    publishers: [
        {
            ...
            config: {
                repository: {
                    owner: APP_CONFIG.repo.split("/")[0],
                    name: APP_CONFIG.repo.split("/")[1],
                },
                prerelease: false,
                draft: true,
